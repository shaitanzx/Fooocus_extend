...
class AsyncTask:
    def __init__(self, args):
        ...
        self.lbw_loraratios = args.pop()
        self.lbw_useblocks = args.pop()
        self.xyzsetting = args.pop()
        self.xtype = args.pop()
        self.xmen = args.pop()
        self.ytype = args.pop()
        self.ymen = args.pop()
        ...
        self.exmen = args.pop()
        self.eymen = args.pop()
        self.ecount = args.pop()
        self.diffcol = args.pop()
        self.lbw_thresh = args.pop()
        self.revxy = args.pop()
        self.elemental = args.pop()
        self.elemsets = args.pop()
        self.lbw_debug = args.pop()
...
def worker():
    ...
    def handler(async_task: AsyncTask):
        ...
        lbw_process(async_task.lbw_loraratios,async_task.lbw_useblocks,async_task.xyzsetting,
                    async_task.xtype,async_task.xmen,async_task.ytype,async_task.ymen,async_task.ztype,
                    async_task.zmen,async_task.exmen,async_task.eymen,async_task.ecount,async_task.diffcol,
                    async_task.lbw_thresh,async_task.revxy,async_task.elemental,async_task.elemsets,
                    async_task.lbw_debug)
            ...
            if async_task.adetailer_checkbox:
                ...
                # inpaint for all other tabs
                    for n, arg_s in enumerate(async_task.enhance_ctrls):
                        ...
                        is_last_adetailer_for_image = (current_task_id + 1) % active_enhance_tabs == 0
