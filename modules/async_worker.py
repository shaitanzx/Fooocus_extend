...
def worker():
    ...
    def process_task(all_steps, async_task, callback, controlnet_canny_path, controlnet_cpds_path, controlnet_pose_path,
        ...
        if async_task.inswapper_enabled:
            ...
            imgs = perform_face_swap(imgs[-1], async_task.inswapper_source_image, async_task.inswapper_source_image_indicies, async_task.inswapper_target_image_indicies)
    ...
    def handler(async_task: AsyncTask):
        ...
        if 'adetail' in goals:
            total_count = len(images_to_adetailer) * active_adetail_tabs
            async_task.images_to_adetail_count = len(images_to_adetailer)
