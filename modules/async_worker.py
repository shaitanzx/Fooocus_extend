    ...
    def process_prompt(async_task, prompt, negative_prompt, base_model_additional_loras, image_number, disable_seed_increment, use_expansion, use_style,
        ...
        if async_task.enable_instant:
            try:
                ...
                hf_hub_download(repo_id="shaitanzx/FooocusExtend", filename="1k3d68.onnx", local_dir=model_path)
                hf_hub_download(repo_id="shaitanzx/FooocusExtend", filename="2d106det.onnx", local_dir=model_path)
                hf_hub_download(repo_id="shaitanzx/FooocusExtend", filename="genderage.onnx", local_dir=model_path)
                hf_hub_download(repo_id="shaitanzx/FooocusExtend", filename="glintr100.onnx", local_dir=model_path)
                hf_hub_download(repo_id="shaitanzx/FooocusExtend", filename="scrfd_10g_bnkps.onnx", local_dir=model_path)
