    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row():
                with gr.Column(scale=17):
                    prompt = gr.Textbox(show_label=False, placeholder="Type prompt here or paste parameters.", elem_id='positive_prompt',
                                        ...
                                        value='masterpiece, best quality, ultra-detailed, (photorealistic:1.2), 1girl, white hair, blue eyes, looking at viewer, <lora:SDXL_FILM_PHOTOGRAPHY_STYLE_V1:1:lbw=ALL:start=0:stop=10>')
            ...
            with gr.Row(elem_classes='extend_row'):
              with gr.Accordion('Extention', open=True):
                with gr.Accordion('in generation', open=True,elem_classes="nested-accordion") as gen_acc:


                        with gr.TabItem(label='LBW'):
                            lbw_loraratios,lbw_useblocks,xyzsetting,xtype,xmen,ytype,ymen,ztype,zmen,exmen,eymen,ecount,diffcol,thresh,revxy,elemental,elemsets,debug = lbw.ui()
        ...
        ctrls += [lbw_loraratios,lbw_useblocks,xyzsetting,xtype,xmen,ytype,ymen,ztype,zmen,exmen,eymen,ecount,diffcol,thresh,revxy,elemental,elemsets,debug]
