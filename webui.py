...
with shared.gradio_root:
    ...
    with gr.Row():
              ...
              with gr.Accordion('Extention', open=False):
                with gr.Accordion('in generation', open=False,elem_classes="nested-accordion") as gen_acc:
                        ...
                        with gr.TabItem(label='InstantID') as instantid_tab:
                            enable_instant,face_file,pose_file_id,identitynet_strength_ratio,adapter_strength_ratio,pre_gen=instantid.gui()                          
        ...
        ctrls += [enable_instant,face_file,pose_file_id,identitynet_strength_ratio,adapter_strength_ratio,pre_gen]
