            ...
            with gr.Row():
                with gr.Column(scale=17):
                    prompt = gr.Textbox(show_label=False, placeholder="Type prompt here or paste parameters.", elem_id='positive_prompt',
                                        ...
                                        value='masterpiece, best quality, ultra-detailed, (photorealistic:1.2), 1girl, white hair, blue eyes, looking at viewer, <lora:SDXL_FILM_PHOTOGRAPHY_STYLE_V1:te=0.25:unet=0.25:lbw=0.3,1.0,1.8>')
