...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            "--test_dataset", type=str, default="Real_RGB_old.bigfile"
        )
        self.parser.add_argument(
            "--no_degradation",
            action="store_true",
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="",
            help="While extracting the features, where to put",
        )
        self.parser.add_argument(
            "--test_input",
            type=str,
            default="",
            help="A directory or a root of bigfile",
        )
        self.parser.add_argument(
            "--test_mask", type=str, default="", help="A directory or a root of bigfile"
        )
        self.parser.add_argument(
            "--test_gt", type=str, default="", help="A directory or a root of bigfile"
        )
        self.parser.add_argument(
            "--scale_input",
            action="store_true",
            help="While testing, choose to scale the input firstly",
        )
        self.parser.add_argument(
            "--save_feature_name",
            type=str,
            default="features.json",
            help="The name of saved features",
        )
        self.parser.add_argument(
            "--test_rgb_old_wo_scratch",
            action="store_true",
            help="Same setting with origin test",
        )
        self.parser.add_argument(
            "--test_mode", type=str, default="Crop", help="Scale|Full|Crop"
        )
        self.parser.add_argument(
            "--Quality_restore", action="store_true", help="For RGB images"
        )
        self.parser.add_argument(
            "--Scratch_and_Quality_restore",
            action="store_true",
            help="For scratched images",
        )
        self.parser.add_argument(
            "--HR", action="store_true", help="Large input size with scratches"
        )
