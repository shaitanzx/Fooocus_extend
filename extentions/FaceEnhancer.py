...
def gui(generator):
    ...
    with gr.Row(visible=False) as swap_mode:
        with gr.Column():
            with gr.Row(visible=generator):
                image_generetor_face=gr.Image(label="Source Face",visible=True,height=260,interactive=True,type="numpy")
    ...
    face_en_start_face.click(lambda: (gr.update(visible=True, interactive=False),gr.update(visible=False),gr.update(visible=False)),outputs=[face_en_start_face,file_out,image_out]) \
              ...
              .then(lambda: (gr.update(visible=False),gr.update(visible=False),gr.update(visible=False)),
              ...
              .then(lambda: (gr.update(visible=True, interactive=True)),outputs=face_en_start_face)  
