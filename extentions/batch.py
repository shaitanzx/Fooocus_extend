    ...
    with gr.Row():
        ...
        with gr.Column():
            with gr.Row():
                ...
                image_out=gr.Image(label="Output image",visible=False,height=260,interactive=Falseб,type="filepath")
...
def output_zip_one():
    ...
    if len(batch_files) == 1:
        return gr.update(value=os.path.join(batch_path, batch_files[0]))
    else:
        zip_file=output_zip()
