onUiLoaded(async() => {
    ...
    function applyZoomAndPan(elemId) {
        ...
        // === ОБЪЕДИНЕННЫЙ ОБРАБОТЧИК КЛИКА С ЛОГИРОВАНИЕМ ДЛЯ ОБОИХ РЕЖИМОВ ===
        function handlePointerDown(e) {
            ...
            // === ЛОГИРОВАНИЕ ПРИ КАЖДОМ КЛИКЕ (и для кисти, и для ластика) ===
            ...
            // Если режим кисти, мы просто выходим из функции. 
            // Событие идет дальше, и Gradio рисует кистью как обычно.
            if (!isEraserMode) {
                return; 
            }

            // === ЛОГИКА ЛАСТИКА (блокируем Gradio) ===
        ...
        // ВАЖНО: Используем handlePointerDown для перехвата клика в обоих режимах
