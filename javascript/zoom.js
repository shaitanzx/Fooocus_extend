onUiLoaded(async() => {
    ...
    function applyZoomAndPan(elemId) {
        ...
        function startErasing(e) {
            ...
            maskCtx.beginPath();
            maskCtx.arc(eraserLastX, eraserLastY, radius, 0, Math.PI * 2);
            maskCtx.fill();
            maskCtx.restore();
            ...
            drawingCtx.arc(eraserLastX, eraserLastY, radius, 0, Math.PI * 2);
            drawingCtx.fill();
            drawingCtx.restore();
        }
        ...
        targetElement.addEventListener("wheel", e => {
            ...
            if (isModifierKey(e, hotkeysConfig.canvas_hotkey_adjust)) {
                ...
                // Мгновенное обновление размера курсора при изменении кисти колесиком
                if (isAltPressed || isEraserDrawing) {
                    updateEraserCursorVisuals({ clientX: lastMousePosition.x, clientY: lastMousePosition.y });
                }
            }
