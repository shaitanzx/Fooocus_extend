...
from extras.basicsr.utils.registry import LOSS_REGISTRY
...
_model_modules = [importlib.import_module(f'extras.basicsr.losses.{file_name}') for file_name in loss_filenames]
