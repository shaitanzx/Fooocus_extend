...
from extras.basicsr.ops.dcn import ModulatedDeformConvPack, modulated_deform_conv
...
class DySample(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            out_ch (int): Number of output channels for the final convolution layer (if used end_convolution).
            scale (int): Upsampling factor. Default is 2.
            groups (int): Number of groups for grouped convolution and offset generation. Default is 4.
            end_convolution (bool): If True, apply a final 1x1 convolution after the upsampling process. Default is True.
        """
        super().__init__()
    ...
    def forward(self, x: Tensor) -> Tensor:
        """
        Forward pass for the DySample module.

        Args:
            x (Tensor): Input tensor of shape (B, C, H, W), where B is the batch size, C is the number of channels,
                        and H, W are the height and width of the input feature map.

        Returns:
            Tensor: Upsampled output tensor of shape (B, out_channels, scale * H, scale * W).
        """
