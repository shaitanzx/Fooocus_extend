...
The file originates from the CodeFormer project by the author sczhou.
...
from extras.gfpgan.archs.vqgan_arch import ResBlock, VQAutoEncoder
from extras.basicsr.utils import get_root_logger
...
class CodeFormer(VQAutoEncoder):
    def __init__(self, dim_embd=512, n_head=8, n_layers=9, 
        ...
        """
        Attributes:
            dim_embd (int): The embedding dimension used in the transformer.
            n_head (int): The number of attention heads in the transformer.
            n_layers (int): The number of layers in the transformer.
            codebook_size (int): The size of the codebook used in vector quantization.
            latent_size (int): The size of the latent space.
            connect_list (list): A list of feature map sizes used for feature fusion.
            fix_modules (list): A list of module names to freeze during training.
            vqgan_path (str): The path to a pre-trained VQGAN model for initialization.
        """
    ...
    def forward(self, x, weight=0, detach_16=True, code_only=False, adain=False, **kwargs):
        ...
        Returns:
            If `code_only` is True:
                logits (Tensor): Logits for code prediction, with shape (B, HW, N).
                lq_feat (Tensor): Low-quality features, used for quantization.
            Otherwise:
                out (Tensor): Enhanced output image features.
                logits (Tensor): Logits for code prediction.
                lq_feat (Tensor): Low-quality features before quantization.
        """
        # ################### Encoder #####################
        enc_feat_dict = {}
